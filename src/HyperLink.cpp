...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// LET OP: Constructor aangepast zodat de control standaard een BN_CLICKED stuurt
//		   naar de parent tbv SC-KeyLog2
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
CHyperLink::CHyperLink()
{
    ...
    m_crHoverColour     = RGB(255, 24, 0);		//::GetSysColor(COLOR_3DHILIGHT);
    m_bOverControl      = FALSE;                // Cursor not yet over control
    m_bVisited          = FALSE;                // Hasn't been visited yet.
    m_bUnderline        = FALSE;                 // Underline the link?
    m_bAdjustToFit      = TRUE;                 // Resize the window to fit the text?
    //m_strURL.Empty();
	m_strURL = NOURL_BUT_COMMAND;
}
