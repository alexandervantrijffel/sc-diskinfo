...
BOOL CDiskInfoApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CDiskInfoDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CDiskInfoView));
...
void CAboutDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_WEB_SUPPORT, m_MailSupport);
	DDX_Control(pDX, IDC_WEB_HOME, m_WebSC);
...
BOOL CAboutDlg::OnInitDialog() 
{
	...
	m_MailSupport.SetURL(_T("mailto:support@soft-central.net?subject=Support%20Request"));
	CString szURL;
	szURL.LoadString(IDS_WEB_SC_HOME);
	m_WebSC.SetURL(szURL);
